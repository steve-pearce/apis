...
// }, (req: any, accessToken: any, refreshToken: any, profile: { id: string; name: { givenName: any; familyName: any; }; _json: { gender: any; email: any; location: { name: any; }; }; }, done: (arg0: NativeError, arg1?: UserDocument) => void) => {
//     if (req.user) {
